    ...
    <>
      ...
      >
        ...
        <div className="max-w-xl z-10 text-gray-500">
          ...
          <p className="text-sm">
            Course by{" "}
            <span className="text-cyan-600 underline">Shamiul Haque</span>
          </p>
                  ...
                  >
                    <div className="flex items-center gap-2">
                      <img
                        ...
                        alt="arrow icon"
                        className={`transform transition-transform ${openSection[idx] ? "rotate-180" : ""}`}
                      />
        ...
        <div
          className="max-w-course-card z-10 shadow-custom-card rounded-t md:rounded-none
                   overflow-hidden bg-white min-w-75 sm:min-w-105"
        >
          {playerData ? (
            <YouTube
